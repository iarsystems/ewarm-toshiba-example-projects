...
volatile Int32U Dummy;
  ...
  /*SPI init*/
  /*Software reset*/
  SSP0CR0_bit.SPH = 0;        /*Captures data at the 1st clock edge*/
  SSP0CR0_bit.SPO = 0;        /*SP0CLK is in Low state*/
  SSP0CR0_bit.FRF = 0;        /*Frame format SPI*/
  SSP0CR0_bit.DSS = 7;        /*Data size select 8 bits*/
    
  SSP0CR1_bit.MS = 0;         /*Device configured as a master*/
  SSP0CR1_bit.LBM = 0;        /*Normal serial port operation enabled*/
