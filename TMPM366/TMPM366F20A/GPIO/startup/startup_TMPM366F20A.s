;/**
; *******************************************************************************
; * @file    startup_TMPM366F20A.s
; * @brief   CMSIS Cortex-M3 Core Device Startup File for the
; *          TOSHIBA 'TMPM366F20A' Device Series 
; * @version V1.0.0.0
; * @date    2015/11/26
; * 
...
__vector_table  DCD     sfe(CSTACK)
                ...
                DCD     INTUART3_IRQHandler       ; 32: UART Interrupt<50% Duty Mode>
                DCD     0                         ; 33: Reserved
                DCD     INTUSBPON_IRQHandler      ; 34: USB V-Bus _Power on Detect
                DCD     INTUART2_IRQHandler       ; 35: UART Interrupt
...
INTSSP2_IRQHandler
                ...
                PUBWEAK INTUART3_IRQHandler
                SECTION .text:CODE:REORDER:NOROOT(1)
INTUART3_IRQHandler
                B       INTUART3_IRQHandler
...
INTUSBPON_IRQHandler
                ...
                PUBWEAK INTUART2_IRQHandler
                SECTION .text:CODE:REORDER:NOROOT(1)
INTUART2_IRQHandler
                B       INTUART2_IRQHandler
