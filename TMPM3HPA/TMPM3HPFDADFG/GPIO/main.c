 ...
 *    TMPM3HPFDADFG family microcontrollers.
 *    It is developed for Toshiba TMPM3HPFDADFG Evaluation Board.
 *
 *    It uses the T32A Timer interrupt handler to toggle PK4-PK7 port pin data.
 *
 *    History :
 *    1. Date        : 08.2008
 ...
 *    3. Date        : 2020/July/16
 *       Author      : Shimizu
 *       Description : Adapted for TMPM3HPFDADFG
 *
 *
 *    $Revision: 64446 $
 **************************************************************************/
