 ...
 *    TMPM3HLFDAUG family microcontrollers.
 *    It is developed for Toshiba TMPM3HLFDAUG Evaluation Board.
 *
 ...
 *    3. Date        : 2020/July/16
 *       Author      : Shimizu
 *       Description : Adapted for TMPM3HLFDAUG
 *    4. Date        : 2020/July/28
 *       Author      : Shimizu
 *       Description : PK7 removed
 *
 *
 *    $Revision: 64446 $
 **************************************************************************/
