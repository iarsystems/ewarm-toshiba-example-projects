...
/*******************************************************************************
* Function Name  : I2C_IO_Configuration
* Description    : Configures I2C IO port
* Input          : None.
* Return         : None.
*******************************************************************************/
void I2C_IO_Configuration(void)
{
	...
	//API_PORT_Out( I2C2_PORT,0x30 );
	API_PORT_Init(I2C2_PORT);
	
	API_PORT_Fr1RegSet( I2C2_PORT,0x30 );
	
	API_PORT_CrRegSet( I2C2_PORT, 0x30 );
	
	API_PORT_IeRegSet( I2C2_PORT, 0x30 );
	
	API_PORT_OdRegSet( I2C2_PORT, 0x30 );
}
