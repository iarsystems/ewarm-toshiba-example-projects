 ...
 *    IAR Embedded Workbench for ARM to develop code for Toshiba TMPM358
 *    family microcontrollers. It is developed for TMPM358-SK Board.
 *     It uses TIMER0 to toggle the LEDs on PORTB.
 *
 *    History :
 *    1. Date        : January 2014
 *       Author      : Stoyan Choynev
 *       Description : Initioal version TMPM358-SK
 *
 * Jumpers:
