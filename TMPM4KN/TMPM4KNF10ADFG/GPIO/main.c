 ...
 *    TMPM4KN family microcontrollers.
 *    It is developed for Toshiba TMPM4KNFWADFG Evaluation Board.
 *
 ...
 *    3. Date        : 2020/Sep/23
 *       Author      : Shimizu
 *       Description : Adapted for TMPM4KNFWADFG
 *    4. Date        : 2022/Sep/13
 *       Author      : Urabe
 *       Description : Adapted for TMPM4KNF10ADFG
  *
 *
 *    $Revision: 64446 $
 **************************************************************************/
