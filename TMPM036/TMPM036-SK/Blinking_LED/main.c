 ...
 *    IAR Embedded Workbench for ARM to develop code for Toshiba TMPM036
 *    family microcontrollers.
 *    It is developed for Toshiba TMPM036-SK Evaluation Board.
 *
 ...
 *       Description : Adapted for TMPM036-SK
 *
 *
 *    $Revision: 41 $
 **************************************************************************/
