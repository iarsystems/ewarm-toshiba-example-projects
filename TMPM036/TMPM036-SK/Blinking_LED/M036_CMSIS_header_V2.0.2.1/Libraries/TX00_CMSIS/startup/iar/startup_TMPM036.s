...
__vector_table  DCD     sfe(CSTACK)
                ...
                DCD     INTRX01_IRQHandler        ; 6:	Serial reception (channel.0/1)
                DCD     INTT16A2_IRQHandler       ; 7:	16-bit TMR16A match detection (channel.2)
                DCD     INTTX01_IRQHandler        ; 8:	Serial transmission (channel.0/1)
                DCD     INTT16A3_IRQHandler       ; 9:	16-bit TMR16A match detection (channel.3)
                DCD     INTDMACB_IRQHandler       ; 10:	DMAC interrupt (unitB)
                DCD     INTI2C1_IRQHandler        ; 11:	Serial bus interface (channel.1)
                DCD     INTI2C0_IRQHandler        ; 12:	Serial bus interface (channel.0)
                DCD     INTDMACA_IRQHandler       ; 13:	DMAC interrupt (unitA)
                ...
                DCD     INTRX235_IRQHandler       ; 24:	Serial reception (channel.2/3/5)
                DCD     INTTMRB8_IRQHandler       ; 25:	16-bit TMRB interrupt(channel.8)
                DCD     INTTX235_IRQHandler       ; 26:	Serial transmission (channel.2/3/5)
                DCD     INTTMRB9_IRQHandler       ; 27:	16-bit TMRB interrupt(channel.9)
...
INT5_IRQHandler
                ...
                PUBWEAK INTRX01_IRQHandler
                SECTION .text:CODE:REORDER:NOROOT(1)
INTRX01_IRQHandler
                B       INTRX01_IRQHandler
...
INTT16A2_IRQHandler
                ...
                PUBWEAK INTTX01_IRQHandler
                SECTION .text:CODE:REORDER:NOROOT(1)
INTTX01_IRQHandler
                B       INTTX01_IRQHandler
...
INTT16A3_IRQHandler
                ...
                PUBWEAK INTDMACB_IRQHandler
                SECTION .text:CODE:REORDER:NOROOT(1)
INTDMACB_IRQHandler
                B       INTDMACB_IRQHandler
...
INTI2C0_IRQHandler
                ...
                PUBWEAK INTDMACA_IRQHandler
                SECTION .text:CODE:REORDER:NOROOT(1)
INTDMACA_IRQHandler
                B       INTDMACA_IRQHandler
...
INTTMRB7_IRQHandler
                ...
                PUBWEAK INTRX235_IRQHandler
                SECTION .text:CODE:REORDER:NOROOT(1)
INTRX235_IRQHandler
                B       INTRX235_IRQHandler

                PUBWEAK INTTMRB8_IRQHandler
                SECTION .text:CODE:REORDER:NOROOT(1)
INTTMRB8_IRQHandler
                B       INTTMRB8_IRQHandler

                PUBWEAK INTTX235_IRQHandler
                SECTION .text:CODE:REORDER:NOROOT(1)
INTTX235_IRQHandler
                B       INTTX235_IRQHandler

                PUBWEAK INTTMRB9_IRQHandler
                SECTION .text:CODE:REORDER:NOROOT(1)
INTTMRB9_IRQHandler
                B       INTTMRB9_IRQHandler
