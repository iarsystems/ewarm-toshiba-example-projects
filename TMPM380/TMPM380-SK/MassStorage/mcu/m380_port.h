/*******************************************************************************
* File Name 		 : m380_port.h
* Version			 : V1.0
* Date				 : 20xx/xx/xx
* Description		 : port header
********************************************************************************/

#ifndef __M380_PORT_H
#define __M380_PORT_H
...
#define		PORT_PBFR1_INIT		BIT8(0,0,1,1,1,0,0,0)
#define		PORT_PBOD_INIT		BIT8(0,0,0,0,0,0,0,0)
#define		PORT_PBPUP_INIT		BIT8(0,0,0,0,1,0,0,0)
#define		PORT_PBPDN_INIT		BIT8(0,0,0,1,0,0,0,0)
#define		PORT_PBIE_INIT		BIT8(0,0,0,1,1,0,0,0)
/*								     | | | | | | | +-------; 
								     | | | | | | +---------; 
								     | | | | | +-----------; 
								     | | | | +-------------; SWDIO
