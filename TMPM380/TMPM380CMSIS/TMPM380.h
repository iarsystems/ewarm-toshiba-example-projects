...
/******  TMPM380 Specific Interrupt Numbers *******************************************************************/
  ...
  INTMTTB00_IRQn                = 80,        /*!< 16-bit MPT0 IGBT period/ compare match detection 0/Over flow*/
...
typedef struct
{
  ...
  __I  uint32_t CNT;               /*!< Encoder Counter Register                     */
} TSB_EN_TypeDef;
...
typedef struct
{
  ...
  __IO uint32_t PSET0;             /*!< PMD Trigger Program Setting Register 0       */
  __IO uint32_t PSET1;             /*!< PMD Trigger Program Setting Register 1       */
  __IO uint32_t PSET2;             /*!< PMD Trigger Program Setting Register 2       */
  __IO uint32_t PSET3;             /*!< PMD Trigger Program Setting Register 3       */
  __IO uint32_t PSET4;             /*!< PMD Trigger Program Setting Register 4       */
  __IO uint32_t PSET5;             /*!< PMD Trigger Program Setting Register 5       */
...
typedef struct
{
  ...
  __IO uint32_t C1CONTROL;         /*!< DMAC Channel1Control Register                */
...
#define TSB_SSP1_BASE              (PERI_BASE  + 0x00C1000UL)
...
#define TSB_MTPD0_MDCNT_MDCNT                     (*((__I  uint32_t *)BITBAND_PERI(&TSB_MTPD0->MDCNT,0)))
...
#define TSB_MTPD1_MDCNT_MDCNT                     (*((__I  uint32_t *)BITBAND_PERI(&TSB_MTPD1->MDCNT,0)))
