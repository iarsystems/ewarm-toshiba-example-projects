...
#define INIT_BUTTONS  { \
    PDFR2 &= ~BUTTON_MASK; PDFR3 &= ~BUTTON_MASK; /* Port Function */ \
...
/* Joystick*/
#define JS_LEFT           (1<<0)
#define JS_LEFT_IE        PGIE
#define JS_LEFT_PORT      PGDATA

#define JS_UP             (1<<1)
#define JS_UP_IE          PGIE
#define JS_UP_PORT        PGDATA

#define JS_RIGHT          (1<<2)
#define JS_RIGHT_IE       PGIE
#define JS_RIGHT_PORT     PGDATA

#define JS_DOWN           (1<<3)
#define JS_DOWN_IE        PGIE
#define JS_DOWN_PORT      PGDATA

#define JS_CENTER         (1<<3)
#define JS_CENTER_IE      PMIE
#define JS_CENTER_PORT    PMDATA

#define JS_INIT() { \
    JS_CENTER_IE |= JS_CENTER;  \
    JS_DOWN_IE   |= JS_DOWN;    \
    JS_RIGHT_IE  |= JS_RIGHT;   \
    JS_UP_IE     |= JS_UP;      \
    JS_LEFT_IE   |= JS_LEFT;    \
  }
