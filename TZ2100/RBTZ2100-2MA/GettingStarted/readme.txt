...
===========
  ...
  to develop code for the Toshiba RBTZ2100-2MA.
  It shows basic use of I/O, timers, GIC and some core initializations.
  TMR0 interrupt is used to blink LED7 at interval of 250ms.

COMPATIBILITY
=============
   The example project is compatible with Toshiba RBTZ2100-2MA board.
...
===============
   ...
   2) Select File->Open->Workspace...
      ...
      TZ2100\RBTZ2100-2MA\GettingStarted\GettingStarted.eww
