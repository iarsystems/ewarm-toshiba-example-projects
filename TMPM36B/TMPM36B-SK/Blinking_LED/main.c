 ...
 *    It is developed for Toshiba TMPM36BFYFG Evaluation Board.
 *
...
/** include files **/
#include <stdio.h>
#include <Toshiba\iotmpm36BFYFG.h>
...
/* Private functions ---------------------------------------------------------*/
  ...
  #define PLLSET_LOWCLK		0x6A8B		/* 80MHz */
  #define PLLSET_HICLK		0x7292		/* 48MHz */
#elif EHOSC == 12000000UL	/* For Xtal Clk source = 12MHz */
  #define PLLSET_LOWCLK		0x610F		/* 72MHz */
  #define PLLSET_HICLK		0x6195		/* 48MHz */
#elif EHOSC == 10000000UL	/* For Xtal Clk source = 10MHz */
  #define PLLSET_LOWCLK		0x711E		/* 80MHz */
  #define PLLSET_HICLK		0x711E		/* 80MHz */
#else						/* For Xtal Clk source = 8MHz (default) */
  #define PLLSET_LOWCLK		0x7117		/* 80MHz */
  #define PLLSET_HICLK		0x71A6		/* 48MHz */
#endif

/*
InitClock set CPU clock = 80MHz
	If low_clock = 0 -> CPU clock = 72MHz / 80MHz
	If low_clock = 1 -> CPU clock = 48MHz
*/
