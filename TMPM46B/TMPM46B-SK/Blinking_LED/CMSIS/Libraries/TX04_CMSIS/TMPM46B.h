...
/******  TMPM46B Specific Interrupt Numbers *******************************************************************/
  ...
  INTSNFCPRRD_IRQn              = 41,        /*!< SNFC page lead RAM transfer end interrupt                   */
  INTSNFPRTCE_IRQn              = 42,        /*!< SNFC decode data RAM transmission end interrupt             */
...
typedef struct
{
  __IO uint32_t SRSTPROTECT;       /*!< Soft reset protect Register                  */
  __IO uint32_t INTIPRST;          /*!< Soft reset Register                          */
} TSB_SRST_TypeDef;
...
#define TSB_SNFC_IE_PRDFLG                        (*((__I  uint32_t *)BITBAND_PERI(&TSB_SNFC->IE,6)))
#define TSB_SNFC_IE_PRDCLR                        (*((__IO uint32_t *)BITBAND_PERI(&TSB_SNFC->IE,7)))
#define TSB_SNFC_IE_RAMFFLAG                      (*((__I  uint32_t *)BITBAND_PERI(&TSB_SNFC->IE,17)))
#define TSB_SNFC_IE_RAMFCLR                       (*((__IO uint32_t *)BITBAND_PERI(&TSB_SNFC->IE,18)))
...
/* Soft Reset */
#define TSB_SRST_INTIPRST_IPRST0                  (*((__IO uint32_t *)BITBAND_PERI(&TSB_SRST->INTIPRST,0)))
#define TSB_SRST_INTIPRST_IPRST1                  (*((__IO uint32_t *)BITBAND_PERI(&TSB_SRST->INTIPRST,1)))
#define TSB_SRST_INTIPRST_IPRST2                  (*((__IO uint32_t *)BITBAND_PERI(&TSB_SRST->INTIPRST,2)))
#define TSB_SRST_INTIPRST_IPRST3                  (*((__IO uint32_t *)BITBAND_PERI(&TSB_SRST->INTIPRST,3)))
#define TSB_SRST_INTIPRST_IPRST4                  (*((__IO uint32_t *)BITBAND_PERI(&TSB_SRST->INTIPRST,4)))
