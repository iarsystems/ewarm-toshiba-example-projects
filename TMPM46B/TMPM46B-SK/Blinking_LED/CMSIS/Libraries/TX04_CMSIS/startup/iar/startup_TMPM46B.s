...
__vector_table  DCD     sfe(CSTACK)
                ...
                DCD     INTSNFCPRRD_IRQHandler    ; 41:	SNFC page lead RAM transfer end interrupt
                DCD     INTSNFPRTCE_IRQHandler    ; 42:	SNFC decode data RAM transmission end interrupt
...
INTSNFCSEQ_IRQHandler
                ...
                PUBWEAK INTSNFCPRRD_IRQHandler
                SECTION .text:CODE:REORDER:NOROOT(1)
INTSNFCPRRD_IRQHandler
                B       INTSNFCPRRD_IRQHandler

                PUBWEAK INTSNFPRTCE_IRQHandler
                SECTION .text:CODE:REORDER:NOROOT(1)
INTSNFPRTCE_IRQHandler
                B       INTSNFPRTCE_IRQHandler
