...
#define PLLSEL_Ready            CG_16M_MUL_4_FPLL
...
#define OSCCR_WUPT_EXT         ((WU_TIME_EXT * EXTALH / HZ_1M /16UL) << 20U) /* OSCCR<WUPT11:0> = warm-up time(us) * EXTALH / 16 */
...
void SystemInit(void)
{
    ...
    TSB_CG->OSCCR &= CG_OSCCR_XEN2_CLEAR ;
