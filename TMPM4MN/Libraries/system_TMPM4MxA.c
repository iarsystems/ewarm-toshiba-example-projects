...
#define SYS_CG_PRCK_FC_1            (0x00000000UL)      /*!< CG ƒÓT0 fc register value */
#define SYS_CG_PRCK_FC_2            (0x00000100UL)      /*!< CG ƒÓT0 fc/2 register value */
#define SYS_CG_PRCK_FC_4            (0x00000200UL)      /*!< CG ƒÓT0 fc/4 register value */
#define SYS_CG_PRCK_FC_8            (0x00000300UL)      /*!< CG ƒÓT0 fc/8 register value */
#define SYS_CG_PRCK_FC_16           (0x00000400UL)      /*!< CG ƒÓT0 fc/16 register value */
#define SYS_CG_PRCK_FC_32           (0x00000500UL)      /*!< CG ƒÓT0 fc/32 register value */
#define SYS_CG_PRCK_FC_64           (0x00000600UL)      /*!< CG ƒÓT0 fc/64 register value */
#define SYS_CG_PRCK_FC_128          (0x00000700UL)      /*!< CG ƒÓT0 fc/128 register value */
#define SYS_CG_PRCK_FC_256          (0x00000800UL)      /*!< CG ƒÓT0 fc/256 register value */
#define SYS_CG_PRCK_FC_512          (0x00000900UL)      /*!< CG ƒÓT0 fc/512 register value */

#define SYS_CG_PLL0SEL_PLL0ON_SET   ((uint32_t)0x00000001)

#define SYS_CG_MCKSEL_1             (0x00000000UL)      /*!< CG fsysm, mƒÓT0 fc value */
#define SYS_CG_MCKSEL_2             (0x00000040UL)      /*!< CG fsysm, mƒÓT0 fc/2 value */
#define SYS_CG_MCKSEL_4             (0x00000080UL)      /*!< CG fsysm, mƒÓT0 fc/4 value */
...
#define CG_WUPHCR_WUON_START_SET             ((uint32_t)0x00000001)
    ...
    #define PLL0SEL_Ready          SYS_CG_10M_MUL_12_FPLL
#endif
...
{                               /* Get Core Clock Frequency */
    ...
    if (pll0sel && pll0on) {                        /* If PLL enabled  */
        if (CoreClock == EOSC_6M) {      /* If input is 6MHz */
            if ((TSB_CG->PLL0SEL & PLL0SEL_MASK) == SYS_CG_6M_MUL_26_656_FPLL) {
...
void SystemInit(void)
{
    ...
    while((TSB_CG->SYSCR & CG_MCKSELGST_MASK) != ((SYSCR_GEAR_Val | SYSCR_PRCK_Val | SYSCR_MCKSEL_Val) & CG_MCKSEL_MASK) << 16U){
        ;
    }                         /* Confirm CGSYSCCR<MCKSELGST>="01" */
    while((TSB_CG->SYSCR & CG_MCKSELPST_MASK) != ((SYSCR_GEAR_Val | SYSCR_PRCK_Val | SYSCR_MCKSEL_Val) & CG_MCKSEL_MASK) << 24U){
        ;
    }                         /* Confirm CGSYSCR<MCKSELPST>="01" */
    while((TSB_CG->SYSCR & CG_PRCKST_MASK) != ((SYSCR_GEAR_Val | SYSCR_PRCK_Val | SYSCR_MCKSEL_Val) & CG_PRCK_MASK) << 16U){
        ;
