 ...
 *
 *    File name   : drv_cg.c
 *    Description : Toshiba TMPM374 Clock/Mode Control Drv
 *
 *    History :
 *    1. Date        : 09.2011
 ...
 * Parameters: cg_foscsel_t fosc - selec internal osc, ext osc
 *             
 * Return: void
 *
 ...
 *
 *************************************************************************/
void CG_SetPll(cg_enable_t pllenable)
{
  ...
  if(CG_ENABLE == pllenable)
  {
    ...
    /*wait to lock 200us*/
    /*PLL sould be use only with exernal oscilator*/
...
void InitClock(cg_clkinit_t * clkinit)
{
  ...
  {/*init PLL*/
      CG_SetPll(clkinit->pll_enable);
  }
  else
  {/*disable PLL*/
      CG_SetPll(CG_DISABLE);
  }
