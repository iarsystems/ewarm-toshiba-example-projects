 ...
 * Workbench for ARM to develop code for Toshiba TMPM372 family
 * microcontrollers. It is developed for Toshiba TMPM372 Eval Board.
 *  The example toggle PD5 (pin 2) with period ~420ms.
 *
 *    History :
 *    1. Date        : 08.2008
 ...
 *       Description : Adapted for TMPM372 Eval board
 *
 *
 *    $Revision: 4200 $
 **************************************************************************/
...
/** include files **/
#include <Toshiba\iotmpm372fwug.h>
...
int main(void)
{
  ...
  // Init PGD5 (pin 2)
  PDFR1_bit.PD5F1 = 0;  /* GPIO */
  PDOD_bit.PD5OD = 0;   /* Push Pull */
  PDCR_bit.PD5C = 1;    /* Output */
