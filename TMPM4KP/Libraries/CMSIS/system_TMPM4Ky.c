...
#define CG_6M_MUL_26_656_FPLL   (0x001C5535UL<<8U)      /* fPLL = 6MHz * 26.656   */
...
#define EXT_CG_WUPHCR_WUCLK_SET              (0x00000000UL)  /* WUCLK for External HOSC select the IHOSC1 */
  ...
  #define PLL0SEL_Ready          CG_12M_MUL_13_312_FPLL
#else
...
#define EOSC_6M_DIV2_PLLON      (159937500UL)   /* 6.00MHz * 53.3125 / 2 */
